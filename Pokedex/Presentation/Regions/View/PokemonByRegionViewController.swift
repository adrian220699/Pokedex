//
//  5. PokemonByRegionViewController.swift
//  Pokedex
//
...
final class PokemonByRegionViewController : UIViewController {
    
    //MARK: - Properties
    
    private let viewModel : PokemonByRegionViewModel
    ...
    init(viewModel: PokemonByRegionViewModel, dependencyContainer: DependencyContainer, regionName: String) {
...
extension PokemonByRegionViewController : UITableViewDataSource {
...
extension PokemonByRegionViewController : UITableViewDelegate {
...
extension PokemonByRegionViewController {
